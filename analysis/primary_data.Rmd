...
<!-- #### Melo-Gavin et al.'s original data -->

<!-- ```{r} -->
<!-- df <- tibble( -->
<!--   chr_type = c("female-limited", "male-limited"), -->
<!--   mean = c(1.0764962187609557, 0.9991861571593129), -->
<!--   SE = c(1.0956453147693694 - 1.0764962187609557,  -->
<!--          1.0255621775930286 - 0.9991861571593129), -->
<!--   n = c(??,??)) -->

<!-- kable(df) %>%  -->
<!--   kable_styling(full_width = F) -->

<!-- Melo-Gavin et al. (2026). bioRxiv, https://doi.org/10.64898/2026.01.23.701411 -->
<!-- ``` -->
