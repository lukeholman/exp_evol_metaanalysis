...
This table is searchable and can be exported as a `.csv` or `.pdf` file. You can also hide columns to help read it. There are `r n_effects` effect sizes from `r n_expts` independent experimental evolution projects, which were published across `r n_pubs` journal articles.
